 ...
 */
static void
code(MMIOT *f, char *s, int length, int save_as_latex)
{
    int i,c;
 ...
 */
static int
mathhandlerExtended(MMIOT *f, char* begin, char* end)
{
